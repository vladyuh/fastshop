...
//Mobile menu init
function mobileMenu() {
  var toggle = document.querySelector(".header-bottom__burger .burger");
...
function initSliders() {
  new Splide(".homepage-compare__slider", {
    perPage: 1,
    arrows: true,
    mediaQuery: "min",
  }).mount();
...
document
  .querySelector(".header-bottom__phone-link")
  .addEventListener("click", function (e) {
    e.stopPropagation();
    this.parentElement.classList.add("is-active");
    document.body.classList.add("page_mobile");
  });

document
  .querySelector(".header-bottom__phone-close")
  .addEventListener("click", function (e) {
    this.parentElement.classList.remove("is-active");
    document.body.classList.remove("page_mobile");
  });

document.addEventListener("click", function (e) {
  if (!findAncestor(e.target, "header-bottom__phone")) {
    document
      .querySelector(".header-bottom__phone")
